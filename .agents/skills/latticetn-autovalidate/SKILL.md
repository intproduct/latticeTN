...
description: Run an eval-driven autonomous implementation loop for the latticeTN automatic-differentiation tensor-network validation project. Use this when the user asks Codex to make latticeTN solve the finite open-boundary 1D spin-1/2 Heisenberg chain with MPS/MPO/autograd and exact diagonalization checks.
---
